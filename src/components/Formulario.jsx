    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-md py-10 px-5 mb-10">
          ...
          <div className="mb-5">
            ...
            <input id="email" type="email" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="Email de Contacto" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"/>
          </div>
          <div className="mb-5">
          ...
          <input type="submit" value= {paciente.id ? 'Editar Paciente' : 'Agregar Paciente'}  className="bg-indigo-600 hover:bg-indigo-700 transition-all w-full p-3 text-white uppercase font-bold" />
        </form>
